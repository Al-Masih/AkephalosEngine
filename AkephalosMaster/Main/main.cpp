...
int main()
{
	sf::RenderWindow window(sf::VideoMode(800, 600), "No estoy de acuerdo con la islamización de Europa, el progresivismo  "); //Creamos una ventana con dimensiones 800x600. 
